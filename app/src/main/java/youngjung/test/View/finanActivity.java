...
public class finanActivity extends baseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        content[0] = "통장잔고가 0원일 때까지 써야 직성이 풀린다구요?<br> 선저축 후지출로 소비와 지출 패턴을 바꿔보는 건 어떠세요?<br><br> <strong>선저축 후지출이란!</strong><br> 목표를 달성하기 위한 저축금액을 도출해서 매월 급여일에 자동이체가 된 후, 나머지 금액으로 지출하는 방법이예요.<br><br> 오늘 부터 <strong>일상 속 불필요한 소비</strong>부터 하나씩 차근차근 줄여보는 건 어떨까요?";
        ...
        content[2] = "귀찮아서 통장 한개에 모든 돈을 넣어놓으시진 않았나요?<br> 돈이 들어오기 직전에 보면 항상 바닥이 보이진 않나요?<br> 그럼, 통장 쪼개기에 집중하세요!<br><br> 금리가 낮아 <strong>월급이나 용돈, 고정지출, 비상금 통장</strong>으로 나누<br>어 관리하는 통장 쪼개기가 재조명을 받고 있어요.<br><br> 돈이 생기면 고정지출<br>이 되는 것은 보내고 월말에 모든 지출을 하고 남은 돈은 비상통장에 저금해보세요.";
        Intent i = getIntent();
