...
public class ReceiptsActivity extends AppCompatActivity implements RecyclerViewAdapter.ItemClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter(this, data, name, price, stamp);
    ...
    // 전 달로 이동
    public void onClick_left_btn(View v) {
        TextView curDate = findViewById(R.id.cur_date);
        String c = curDate.getText().charAt(5) + curDate.getText().charAt(6) + "";
        Toast.makeText(this, "before !" + curDate.getText().charAt(0), Toast.LENGTH_SHORT).show();
    }

    // 다음 달로 이동
    public void onClick_right_btn(View v) {
        TextView curDate = findViewById(R.id.cur_date);
        Toast.makeText(this, "after !" + curDate.getText(), Toast.LENGTH_SHORT).show();
    }
}
